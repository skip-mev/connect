...
func main() {
	...
	// data collection handlers for the providers.
	apiFactory := oraclefactory.DefaultAPIQueryHandlerFactory()      // Replace with custom API factory.
	wsFactory := oraclefactory.DefaultWebSocketQueryHandlerFactory() // Replace with custom websocket factory.
