...
func (k Keeper) SetPriceFeed(
	...
	key := collections.Join3(priceFeed.ID, priceFeed.CurrencyPair.ToString(), priceFeed.Validator)
...
func (k Keeper) GetPriceFeed(
	...
	key := collections.Join3(slaID, cp.ToString(), consAddress.Bytes())
...
func (k Keeper) RemovePriceFeedByCurrencyPair(
	...
	prefix := collections.NewSuperPrefixedTripleRange[string, string, []byte](slaID, cp.ToString())
...
func (k Keeper) ContainsPriceFeed(
	...
	key := collections.Join3(slaID, cp.ToString(), validator.Bytes())
