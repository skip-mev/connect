...
func (m *EnabledTickers) Reset()         { *m = EnabledTickers{} }
func (m *EnabledTickers) String() string { return proto.CompactTextString(m) }
func (*EnabledTickers) ProtoMessage()    {}
func (*EnabledTickers) Descriptor() ([]byte, []int) {
	return fileDescriptor_fefe265720fc8a78, []int{6}
}
func (m *EnabledTickers) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EnabledTickers) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EnabledTickers.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *EnabledTickers) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EnabledTickers.Merge(m, src)
}
func (m *EnabledTickers) XXX_Size() int {
	return m.Size()
}
func (m *EnabledTickers) XXX_DiscardUnknown() {
	xxx_messageInfo_EnabledTickers.DiscardUnknown(m)
}

var xxx_messageInfo_EnabledTickers proto.InternalMessageInfo

func (m *EnabledTickers) GetTickers() []string {
	if m != nil {
		return m.Tickers
	}
	return nil
...
type MarketMap struct {
	...
	EnabledTickers EnabledTickers `protobuf:"bytes,4,opt,name=enabled_tickers,json=enabledTickers,proto3" json:"enabled_tickers"`
}
...
func (m *MarketMap) GetEnabledTickers() EnabledTickers {
	if m != nil {
		return m.EnabledTickers
	}
...
func init() {
	...
	proto.RegisterType((*EnabledTickers)(nil), "slinky.marketmap.v1.EnabledTickers")
...
var fileDescriptor_fefe265720fc8a78 = []byte{
	...
	,
}
...
func (m *EnabledTickers) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *EnabledTickers) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EnabledTickers) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Tickers) > 0 {
		for iNdEx := len(m.Tickers) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintMarket(dAtA, i, uint64(len(m.Tickers[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *MarketMap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.EnabledTickers.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *EnabledTickers) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EnabledTickers) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EnabledTickers: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EnabledTickers: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MarketMap) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnabledTickers", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.EnabledTickers.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
