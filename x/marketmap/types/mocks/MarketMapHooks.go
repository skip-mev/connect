...
// BeforeMarketUpdate provides a mock function with given fields: ctx, current, update
func (_m *MarketMapHooks) BeforeMarketUpdate(ctx types.Context, current marketmaptypes.Market, update marketmaptypes.Market) error {
	ret := _m.Called(ctx, current, update)

	if len(ret) == 0 {
		panic("no return value specified for BeforeMarketUpdate")
	}

	var r0 error
	if rf, ok := ret.Get(0).(func(types.Context, marketmaptypes.Market, marketmaptypes.Market) error); ok {
		r0 = rf(ctx, current, update)
	} else {
		r0 = ret.Error(0)
	}
...
// MarketMapHooks_BeforeMarketUpdate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BeforeMarketUpdate'
type MarketMapHooks_BeforeMarketUpdate_Call struct {
	*mock.Call
}

// BeforeMarketUpdate is a helper method to define mock.On call
//   - ctx types.Context
//   - current marketmaptypes.Market
//   - update marketmaptypes.Market
func (_e *MarketMapHooks_Expecter) BeforeMarketUpdate(ctx interface{}, current interface{}, update interface{}) *MarketMapHooks_BeforeMarketUpdate_Call {
	return &MarketMapHooks_BeforeMarketUpdate_Call{Call: _e.mock.On("BeforeMarketUpdate", ctx, current, update)}
}

func (_c *MarketMapHooks_BeforeMarketUpdate_Call) Run(run func(ctx types.Context, current marketmaptypes.Market, update marketmaptypes.Market)) *MarketMapHooks_BeforeMarketUpdate_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(types.Context), args[1].(marketmaptypes.Market), args[2].(marketmaptypes.Market))
	})
	return _c
}

func (_c *MarketMapHooks_BeforeMarketUpdate_Call) Return(_a0 error) *MarketMapHooks_BeforeMarketUpdate_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MarketMapHooks_BeforeMarketUpdate_Call) RunAndReturn(run func(types.Context, marketmaptypes.Market, marketmaptypes.Market) error) *MarketMapHooks_BeforeMarketUpdate_Call {
	_c.Call.Return(run)
	return _c
}
