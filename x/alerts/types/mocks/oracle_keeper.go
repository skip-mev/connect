...
func (_m *OracleKeeper) HasCurrencyPair(ctx types.Context, cp slinkytypes.CurrencyPair) bool {
	...
	var r0 bool
	if rf, ok := ret.Get(0).(func(types.Context, slinkytypes.CurrencyPair) bool); ok {
		r0 = rf(ctx, cp)
	} else {
		r0 = ret.Get(0).(bool)
	}
