...
func (m *RemovedCPsRequest) Reset()         { *m = RemovedCPsRequest{} }
func (m *RemovedCPsRequest) String() string { return proto.CompactTextString(m) }
...
func (m *RemovedCPsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RemovedCPsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RemovedCPsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RemovedCPsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemovedCPsRequest.Merge(m, src)
}
func (m *RemovedCPsRequest) XXX_Size() int {
	return m.Size()
}
func (m *RemovedCPsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_RemovedCPsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_RemovedCPsRequest proto.InternalMessageInfo
...
func (m *RemovedCPsResponse) Reset()         { *m = RemovedCPsResponse{} }
func (m *RemovedCPsResponse) String() string { return proto.CompactTextString(m) }
...
func (m *RemovedCPsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RemovedCPsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_RemovedCPsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *RemovedCPsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RemovedCPsResponse.Merge(m, src)
}
func (m *RemovedCPsResponse) XXX_Size() int {
	return m.Size()
}
func (m *RemovedCPsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_RemovedCPsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_RemovedCPsResponse proto.InternalMessageInfo

func (m *RemovedCPsResponse) GetNumberRemovedCPs() uint64 {
	if m != nil {
		return m.NumberRemovedCPs
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*RemovedCPsRequest)(nil), "slinky.oracle.v1.RemovedCPsRequest")
	proto.RegisterType((*RemovedCPsResponse)(nil), "slinky.oracle.v1.RemovedCPsResponse")
}
...
var fileDescriptor_ba8e832073f3a7b0 = []byte{
	...
	,
}
...
func (c *queryClient) RemovedCPs(ctx context.Context, in *RemovedCPsRequest, opts ...grpc.CallOption) (*RemovedCPsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/slinky.oracle.v1.Query/RemovedCPs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) RemovedCPs(ctx context.Context, req *RemovedCPsRequest) (*RemovedCPsResponse, error) {
...
func _Query_RemovedCPs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/slinky.oracle.v1.Query/RemovedCPs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *RemovedCPsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RemovedCPsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemovedCPsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *RemovedCPsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RemovedCPsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RemovedCPsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.NumberRemovedCPs != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.NumberRemovedCPs))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *RemovedCPsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RemovedCPsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.NumberRemovedCPs != 0 {
		n += 1 + sovQuery(uint64(m.NumberRemovedCPs))
	}
	return n
}
...
func (m *RemovedCPsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RemovedCPsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RemovedCPsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *RemovedCPsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RemovedCPsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RemovedCPsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NumberRemovedCPs", wireType)
			}
			m.NumberRemovedCPs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowQuery
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NumberRemovedCPs |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
