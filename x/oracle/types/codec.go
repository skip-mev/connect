...
func RegisterLegacyAminoCodec(cdc *codec.LegacyAmino) {
	...
	legacy.RegisterAminoMsg(cdc, &MsgAddCurrencyPairs{}, "oracle/MsgAddCurrencyPairs")

	// register the MsgRemoveCurrencyPairs for amino serialization
	legacy.RegisterAminoMsg(cdc, &MsgRemoveCurrencyPairs{}, "oracle/MsgRemoveCurrencyPairs")
}
