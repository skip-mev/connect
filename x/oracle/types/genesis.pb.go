...
type TickerPrice struct {
	...
	Timestmap *time.Time                             `protobuf:"bytes,2,opt,name=timestmap,proto3,stdtime" json:"timestmap,omitempty"`
}
...
func (m *TickerPrice) GetTimestmap() *time.Time {
	if m != nil {
		return m.Timestmap
	}
	return nil
...
var fileDescriptor_4f99f7f904ffca77 = []byte{
	...
	,
}
...
func (m *TickerPrice) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Timestmap != nil {
		n1, err1 := github_com_cosmos_gogoproto_types.StdTimeMarshalTo(*m.Timestmap, dAtA[i-github_com_cosmos_gogoproto_types.SizeOfStdTime(*m.Timestmap):])
		if err1 != nil {
			return 0, err1
		}
		i -= n1
...
func (m *TickerPrice) Size() (n int) {
	...
	n += 1 + l + sovGenesis(uint64(l))
	if m.Timestmap != nil {
		l = github_com_cosmos_gogoproto_types.SizeOfStdTime(*m.Timestmap)
		n += 1 + l + sovGenesis(uint64(l))
	}
	return n
}
...
func (m *TickerPrice) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Timestmap == nil {
				m.Timestmap = new(time.Time)
			}
			if err := github_com_cosmos_gogoproto_types.StdTimeUnmarshal(m.Timestmap, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
