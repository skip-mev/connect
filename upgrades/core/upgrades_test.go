...
func (s *UpgradeTestSuite) TestSlinkyCoreUpgrade() {
	...
	s.Require().NoError(err)
	s.Require().Equal(params.MarketAuthorities[0], "neutron1hxskfdxpp5hqgtjj6am6nkjefhfzj359x0ar3z")
	s.Require().Equal(params.Admin, "neutron1hxskfdxpp5hqgtjj6am6nkjefhfzj359x0ar3z")
