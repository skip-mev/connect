...
func (_m *Oracle) GetPrices() map[types.CurrencyPair]*uint256.Int {
	ret := _m.Called()

	var r0 map[types.CurrencyPair]*uint256.Int
	if rf, ok := ret.Get(0).(func() map[types.CurrencyPair]*uint256.Int); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[types.CurrencyPair]*uint256.Int)
		}
	}
