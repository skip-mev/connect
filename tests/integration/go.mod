...
replace (
	...
	github.com/strangelove-ventures/interchaintest/v7 => github.com/skip-mev/interchaintest/v7 v7.0.0 // TODO(nikhil): move away from skip fork when possible
)
...
require (
	...
	github.com/cosmos/cosmos-sdk v0.50.0-beta.0.0.20230815220017-9645227115b8
...
require (
	...
	cosmossdk.io/x/upgrade v0.0.0-20230722073756-0fa85b7a424d // indirect
