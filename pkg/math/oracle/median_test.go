...
var (
	...
	cfg       = config.AggregateMarketConfig{
		Feeds: map[string]config.FeedConfig{
			...
			"BITCOIN/ETHEREUM": {
				CurrencyPair: oracletypes.NewCurrencyPair("BITCOIN", "ETHEREUM", oracletypes.EthereumDecimals),
			},
			"USDT/ETHEREUM": {
				CurrencyPair: oracletypes.NewCurrencyPair("USDT", "ETHEREUM", oracletypes.EthereumDecimals),
			},
			"ETHEREUM/USD": {
...
func TestMedian(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			pricesPerProvider: map[string]map[oracletypes.CurrencyPair]*big.Int{
				"coinbase": {
					oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals): createPrice(40_000, 8),
				},
			},
			expected: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals): createPrice(40_000, 8),
		...
		},
		{
			...
			pricesPerProvider: map[string]map[oracletypes.CurrencyPair]*big.Int{
				"coinbase": {
					oracletypes.NewCurrencyPair("BITCOIN", "USDT", oracletypes.DefaultDecimals): createPrice(40_000, 8),
					oracletypes.NewCurrencyPair("USDT", "USD", oracletypes.DefaultDecimals):     createPrice(1.1, 8),
				},
			},
			expected: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals): createPrice(44_000, 8),
			},
		},
		{
			...
			expected: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals): createPrice(42_000, 8), // median average of 40_000 and 44_000
			},
		},
		{
			...
			pricesPerProvider: map[string]map[oracletypes.CurrencyPair]*big.Int{
				"coinbase": {
					...
					oracletypes.NewCurrencyPair("BITCOIN", "USDT", oracletypes.DefaultDecimals):      createPrice(40_000, 8),
					oracletypes.NewCurrencyPair("USDT", "USD", oracletypes.DefaultDecimals):          createPrice(1.1, 8),
					oracletypes.NewCurrencyPair("BITCOIN", "ETHEREUM", oracletypes.EthereumDecimals): createPrice(22, 18),
					oracletypes.NewCurrencyPair("ETHEREUM", "USDT", oracletypes.DefaultDecimals):     createPrice(2000, 8),
				},
			},
			expected: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals):  createPrice(44_000, 8), // median average of 40_000, 44_000, and 48_400
				oracletypes.NewCurrencyPair("ETHEREUM", "USD", oracletypes.DefaultDecimals): createPrice(2_200, 8),
			},
		},
		{
			...
			pricesPerProvider: map[string]map[oracletypes.CurrencyPair]*big.Int{
				"coinbase": {
					oracletypes.NewCurrencyPair("USDT", "ETHEREUM", oracletypes.EthereumDecimals): createPrice(0.0005, 18),
					oracletypes.NewCurrencyPair("USDT", "USD", oracletypes.DefaultDecimals): createPrice(1.1,
						8),
				},
			},
			expected: map[oracletypes.CurrencyPair]*big.Int{
		...
		},
		{
			...
			pricesPerProvider: map[string]map[oracletypes.CurrencyPair]*big.Int{
				"coinbase": {
					oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals): createPrice(0, 8),
				},
			},
			expected: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals): createPrice(0, 8),
...
func TestCalculateConvertedPrices(t *testing.T) {
	testCases := []struct {
		...
		{
			name:       "no operations",
			outcome:    oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals),
			operations: []config.Conversion{},
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals): createPrice(40_000, 8),
			},
		...
		},
		{
			...
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USD", oracletypes.DefaultDecimals): createPrice(40_000, oracle.ScaledDecimals),
			},
		...
		},
		{
			...
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USDT", oracletypes.DefaultDecimals): createPrice(40_000, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("USDT", "USD", oracletypes.DefaultDecimals):     createPrice(1.2, oracle.ScaledDecimals),
			},
		...
		},
		{
			...
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("USDT", "BITCOIN", oracletypes.DefaultDecimals): createPrice(0.000025, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("USDT", "USD", oracletypes.DefaultDecimals):     createPrice(1.2, oracle.ScaledDecimals),
			},
			expected:      createPrice(48_000, oracle.ScaledDecimals),
			expectedError: false,
		},
		{
			...
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USDT", oracletypes.DefaultDecimals): createPrice(0.0000000000004, oracle.ScaledDecimals), // 4e-13
				oracletypes.NewCurrencyPair("USDT", "USD", oracletypes.DefaultDecimals):     createPrice(0.0000000000012, oracle.ScaledDecimals), // 1.2e-12
			},
		...
		},
		{
			...
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "USDT", oracletypes.DefaultDecimals): createPrice(40_000_000_000_000_000, oracle.ScaledDecimals), // 4e16 + scaled to 40 decimals
				oracletypes.NewCurrencyPair("USDT", "USD", oracletypes.DefaultDecimals):     createPrice(1_200_000, oracle.ScaledDecimals),
			},
		...
		},
		{
			...
			outcome: oracletypes.NewCurrencyPair("BITCOIN", "USD", oracle.ScaledDecimals),
			operations: []config.Conversion{
				{
					CurrencyPair: oracletypes.NewCurrencyPair("BITCOIN", "ETHEREUM", oracle.ScaledDecimals),
				},
				{
					CurrencyPair: oracletypes.NewCurrencyPair("ETHEREUM", "USDT", oracle.ScaledDecimals),
				},
				{
					CurrencyPair: oracletypes.NewCurrencyPair("USDT", "USD", oracle.ScaledDecimals),
				},
			},
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "ETHEREUM", oracle.ScaledDecimals): createPrice(20, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("ETHEREUM", "USDT", oracle.ScaledDecimals):    createPrice(2000, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("USDT", "USD", oracle.ScaledDecimals):         createPrice(1.2, oracle.ScaledDecimals),
			},
			expected:      createPrice(48_000, oracle.ScaledDecimals),
			expectedError: false,
		},
		{
			...
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "ETHEREUM", oracle.ScaledDecimals): createPrice(0, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("ETHEREUM", "USDT", oracle.ScaledDecimals):    createPrice(2000, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("USDT", "USD", oracle.ScaledDecimals):         createPrice(1.2, oracle.ScaledDecimals),
			},
		...
		},
		{
			...
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "ETHEREUM", oracletypes.EthereumDecimals): createPrice(20, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("ETHEREUM", "USDT", oracletypes.DefaultDecimals):     createPrice(0, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("USDT", "USD", oracletypes.DefaultDecimals):          createPrice(1.2, oracle.ScaledDecimals),
			},
			expected:      big.NewInt(0),
			expectedError: false,
		},
		{
			...
			medians: map[oracletypes.CurrencyPair]*big.Int{
				oracletypes.NewCurrencyPair("BITCOIN", "ETHEREUM", oracletypes.EthereumDecimals): createPrice(20, oracle.ScaledDecimals),
				oracletypes.NewCurrencyPair("ETHEREUM", "USDT", oracletypes.DefaultDecimals):     createPrice(2000, oracle.ScaledDecimals),
			},
			expected:      nil,
			expectedError: true,
		},
