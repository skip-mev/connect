module github.com/skip-mev/slinky/providers/apis/defi/osmosis

go 1.22.5

require (
	github.com/osmosis-labs/osmosis/v25 v25.0.0-20240708102315-194ef2da5f0d
...
replace github.com/skip-mev/slinky => ../../../../.
