...
const (
	...
	// DefaultPostConnectionTimeout is the default timeout for post connection setup. Sleep for a second to ensure
	// the connection is established before sending the subscribe message. This is the recommended behaviour from
	// the Crypto.com documentation.
	//
	// ref: https://exchange-docs.crypto.com/exchange/v1/rest-ws/index.html#introduction-2
