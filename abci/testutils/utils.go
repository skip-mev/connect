...
func CreateExtendedCommitInfo(commitInfo []cometabci.ExtendedVoteInfo, round int32, codec compression.ExtendedCommitCodec) (cometabci.ExtendedCommitInfo, []byte, error) {
