...
// GetCPCounter provides a mock function with given fields: ctx
func (_m *OracleKeeper) GetCPCounter(ctx types.Context) (uint64, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetCPCounter")
	}
...
// GetRemovedCPCounter provides a mock function with given fields: ctx
func (_m *OracleKeeper) GetRemovedCPCounter(ctx types.Context) (uint64, error) {
	ret := _m.Called(ctx)

	if len(ret) == 0 {
		panic("no return value specified for GetRemovedCPCounter")
	}
