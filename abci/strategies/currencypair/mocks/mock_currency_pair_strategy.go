...
func (_m *CurrencyPairStrategy) FromID(ctx types.Context, id uint64) (slinkytypes.CurrencyPair, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, uint64) (slinkytypes.CurrencyPair, error)); ok {
		return rf(ctx, id)
	}
...
func (_m *CurrencyPairStrategy) GetDecodedPrice(ctx types.Context, cp slinkytypes.CurrencyPair, priceBytes []byte) (*big.Int, error) {
	...
	var r0 *big.Int
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, slinkytypes.CurrencyPair, []byte) (*big.Int, error)); ok {
		return rf(ctx, cp, priceBytes)
	}
	if rf, ok := ret.Get(0).(func(types.Context, slinkytypes.CurrencyPair, []byte) *big.Int); ok {
	...
	if rf, ok := ret.Get(1).(func(types.Context, slinkytypes.CurrencyPair, []byte) error); ok {
...
func (_m *CurrencyPairStrategy) GetEncodedPrice(ctx types.Context, cp slinkytypes.CurrencyPair, price *big.Int) ([]byte, error) {
	...
	var r0 []byte
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, slinkytypes.CurrencyPair, *big.Int) ([]byte, error)); ok {
		return rf(ctx, cp, price)
	}
	if rf, ok := ret.Get(0).(func(types.Context, slinkytypes.CurrencyPair, *big.Int) []byte); ok {
		r0 = rf(ctx, cp, price)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
	...
	if rf, ok := ret.Get(1).(func(types.Context, slinkytypes.CurrencyPair, *big.Int) error); ok {
		r1 = rf(ctx, cp, price)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *CurrencyPairStrategy) ID(ctx types.Context, cp slinkytypes.CurrencyPair) (uint64, error) {
	...
	var r0 uint64
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, slinkytypes.CurrencyPair) (uint64, error)); ok {
		return rf(ctx, cp)
	}
