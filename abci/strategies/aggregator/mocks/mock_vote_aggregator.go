...
func (_m *VoteAggregator) AggregateOracleVotes(ctx types.Context, votes []aggregator.Vote) (map[oracletypes.CurrencyPair]*big.Int, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(types.Context, []aggregator.Vote) (map[oracletypes.CurrencyPair]*big.Int, error)); ok {
		return rf(ctx, votes)
	}
	if rf, ok := ret.Get(0).(func(types.Context, []aggregator.Vote) map[oracletypes.CurrencyPair]*big.Int); ok {
		r0 = rf(ctx, votes)
	} else {
		if ret.Get(0) != nil {
...
func (_m *VoteAggregator) GetPriceForValidator(validator types.ConsAddress) map[oracletypes.CurrencyPair]*big.Int {
	...
	var r0 map[oracletypes.CurrencyPair]*big.Int
	if rf, ok := ret.Get(0).(func(types.ConsAddress) map[oracletypes.CurrencyPair]*big.Int); ok {
		r0 = rf(validator)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[oracletypes.CurrencyPair]*big.Int)
