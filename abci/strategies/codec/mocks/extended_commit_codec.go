...
type mockConstructorTestingTNewExtendedCommitCodec interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewExtendedCommitCodec(t mockConstructorTestingTNewExtendedCommitCodec) *ExtendedCommitCodec {
