...
type mockConstructorTestingTNewVoteExtensionCodec interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewVoteExtensionCodec(t mockConstructorTestingTNewVoteExtensionCodec) *VoteExtensionCodec {
