...
func WithAggregateFunction(fn aggregator.AggregateFn[string, map[mmtypes.Ticker]*big.Int]) Option {
	return func(o *OracleImpl) {
		if fn == nil {
			panic("cannot set aggregate function on nil aggregator")
		}

		o.priceAggregator = aggregator.NewDataAggregator[string, map[mmtypes.Ticker]*big.Int](
...
func WithDataAggregator(agg *aggregator.DataAggregator[string, map[mmtypes.Ticker]*big.Int]) Option {
	return func(o *OracleImpl) {
		if agg == nil {
...
func WithProviders(providers []providertypes.Provider[mmtypes.Ticker, *big.Int]) Option {
	return func(o *OracleImpl) {
