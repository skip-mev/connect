...
type (
	...
	PriceProviderFactory = factory.BaseProviderFactory[ProviderTicker, *big.Int]

	// PriceProviderFactory is a type alias for the price provider factory. This
	// specifically only returns price providers that implement the provider interface.
	PriceProviderFactoryI = factory.ProviderFactory[ProviderTicker, *big.Int]
	...
	PriceProvider = base.Provider[ProviderTicker, *big.Int]
	...
	PriceProviderI = providertypes.Provider[ProviderTicker, *big.Int]
	...
	PriceAPIFetcher = apihandlers.APIFetcher[ProviderTicker, *big.Int]
	...
	PriceAPIDataHandler = apihandlers.APIDataHandler[ProviderTicker, *big.Int]
	...
	PriceAPIQueryHandler = apihandlers.APIQueryHandler[ProviderTicker, *big.Int]
	...
	// and unresolved prices.
	PriceWebSocketDataHandler = wshandlers.WebSocketDataHandler[ProviderTicker, *big.Int]
	...
	// returning the resolved and unresolved prices.
	PriceWebSocketQueryHandler = wshandlers.WebSocketQueryHandler[ProviderTicker, *big.Int]
	...
	ResolvedPrices = map[ProviderTicker]providertypes.ResolvedResult[*big.Int]
...
var (
	...
	NewPriceResponse = providertypes.NewGetResponse[ProviderTicker, *big.Int]

	// NewPriceResponseWithErr is a function alias for the new price response with errors.
	NewPriceResponseWithErr = providertypes.NewGetResponseWithErr[ProviderTicker, *big.Int]

	// NewPriceProvider is a function alias for the new price provider.
	NewPriceProvider = base.NewProvider[ProviderTicker, *big.Int]

	// NewPriceAPIQueryHandler is a function alias for the new API query handler meant to be
	// used by the price providers.
	NewPriceAPIQueryHandler = apihandlers.NewAPIQueryHandler[ProviderTicker, *big.Int]

	// NewPriceWebSocketQueryHandler is a function alias for the new web socket query handler meant to be
	// used by the price providers.
	NewPriceWebSocketQueryHandler = wshandlers.NewWebSocketQueryHandler[ProviderTicker, *big.Int]
