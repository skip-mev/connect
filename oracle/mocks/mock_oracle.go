...
func (_m *Oracle) GetPrices() oracletypes.Prices {
	ret := _m.Called()
	...
	var r0 oracletypes.Prices
	if rf, ok := ret.Get(0).(func() oracletypes.Prices); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(oracletypes.Prices)
	}
...
func (_c *Oracle_GetPrices_Call) Return(_a0 oracletypes.Prices) *Oracle_GetPrices_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Oracle_GetPrices_Call) RunAndReturn(run func() oracletypes.Prices) *Oracle_GetPrices_Call {
	_c.Call.Return(run)
	return _c
}
