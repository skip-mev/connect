...
import (
	...
	types "github.com/skip-mev/slinky/x/mm2/types"
)
...
func (_m *Oracle) GetPrices() map[types.Ticker]*big.Int {
	ret := _m.Called()
	...
	var r0 map[types.Ticker]*big.Int
	if rf, ok := ret.Get(0).(func() map[types.Ticker]*big.Int); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[types.Ticker]*big.Int)
		}
	}
