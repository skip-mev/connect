...
import (
	...
	types "github.com/skip-mev/connect/v2/oracle/types"
)
...
func (_m *PriceAggregator) GetPrices() types.Prices {
	ret := _m.Called()
	...
	var r0 types.Prices
	if rf, ok := ret.Get(0).(func() types.Prices); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(types.Prices)
		}
	}
...
func (_c *PriceAggregator_GetPrices_Call) Return(_a0 types.Prices) *PriceAggregator_GetPrices_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *PriceAggregator_GetPrices_Call) RunAndReturn(run func() types.Prices) *PriceAggregator_GetPrices_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *PriceAggregator) SetProviderPrices(provider string, prices types.Prices) {
...
func (_c *PriceAggregator_SetProviderPrices_Call) Run(run func(provider string, prices types.Prices)) *PriceAggregator_SetProviderPrices_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(types.Prices))
	})
	return _c
}
...
func (_c *PriceAggregator_SetProviderPrices_Call) RunAndReturn(run func(string, types.Prices)) *PriceAggregator_SetProviderPrices_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateMarketMap provides a mock function with given fields: _a0
func (_m *PriceAggregator) UpdateMarketMap(_a0 marketmaptypes.MarketMap) {
	_m.Called(_a0)
}
...
func (_c *PriceAggregator_UpdateMarketMap_Call) Run(run func(_a0 marketmaptypes.MarketMap)) *PriceAggregator_UpdateMarketMap_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(marketmaptypes.MarketMap))
	})
	return _c
}
...
func (_c *PriceAggregator_UpdateMarketMap_Call) RunAndReturn(run func(marketmaptypes.MarketMap)) *PriceAggregator_UpdateMarketMap_Call {
	_c.Call.Return(run)
	return _c
}
