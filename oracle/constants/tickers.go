...
var (
	...
	DOGE_USD      = mmtypes.NewTicker("DOGE", "USD", 18, 1)
	...
	MOG_USD       = mmtypes.NewTicker("MOG", "USD", 18, 1)
	...
	PEPE_USD      = mmtypes.NewTicker("PEPE", "USD", 18, 1)
	...
	SHIBA_USD     = mmtypes.NewTicker("SHIB", "USD", 18, 1)
	...
	DOGE_USDC      = mmtypes.NewTicker("DOGE", "USDC", 18, 1)
	...
	MOG_USDC       = mmtypes.NewTicker("MOG", "USDC", 18, 1)
	...
	PEPE_USDC      = mmtypes.NewTicker("PEPE", "USDC", 18, 1)
	...
	SHIBA_USDC     = mmtypes.NewTicker("SHIB", "USDC", 18, 1)
	...
	DOGE_USDT      = mmtypes.NewTicker("DOGE", "USDT", 18, 1)
	...
	MOG_USDT       = mmtypes.NewTicker("MOG", "USDT", 18, 1)
	...
	PEPE_USDT      = mmtypes.NewTicker("PEPE", "USDT", 18, 1)
	...
	SHIBA_USDT     = mmtypes.NewTicker("SHIB", "USDT", 18, 1)
