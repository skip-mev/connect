...
## What is Connect?
**Connect** is an in-protocol oracle that securely delivers data to blockchain applications via their own validator set. This documentation will guide you through using Connect; whether you're a **validator** or **developer**.
...
Connect can support over 2000 currency pairs and price feeds, allowing the launch of thousands of permissionless on-chain markets.
...
If you're interested in using Connect, please check out our [website](https://skip.build) and reach out to us to get started.