...
The Slinky binary sets sane defaults for as many values as possible. Depending on the chain you're operating for, you may need to override some of the default values.

Please see our [slinky config](/validator/validator-slinky-config) page for a complete reference on configurable values. Additionally, our [chain config](/validator/validator-app-config) has references for particular integrations.
