...
<AccordionGroup>
    ...
    <Accordion title="What do I do if I experience trouble running Connect?">
        If you're a validator and need help getting your infrastructure setup, head over to our [discord](https://discord.com/invite/hFeHVAE26P) and let us know you need access to the channel for the chain you are validator for in the `#waiting-room` channel.
    </Accordion>
</AccordionGroup>
