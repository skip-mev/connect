...
Some chains include markets that require API keys to provide data for. To set these API keys, you will need to utilize the `--oracle-config` flag and pass in a `json` file that looks like the following:
