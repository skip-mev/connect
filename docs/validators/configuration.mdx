...
| `SLINKY_CONFIG_METRICS_ENABLED`                 | `"false"`   | Enables prometheus metrics.                                                                                                                        |
| `SLINKY_CONFIG_METRICS_PROMETHEUSSERVERADDRESS` | `""`        | The address of your prometheus server instance.                                                                                                    |
