...
Note: The following instructions assumes you are running a single validator node with a remote instance of Connect.
...
Remember to change the `oracle_address` value to the address of your Connect instance!
...
[oracle]
enabled = "true"
oracle_address = "<YOUR_CONNECT_INSTANCE>:8080"
