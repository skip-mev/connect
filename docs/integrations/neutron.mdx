...
2. **Integrate the Slinky sidecar into your setup.**
   ...
   > Notice, some default values may need to change depending on how you've setup your node + slinky-sidecar. See the **marketmap-provider** [section](/validator/flags-guide#marketmap-provider) of the [flags-guide](/validator/flags-guide)
