...
1. **Download the Connect Sidecar binary.**

   The best way to get the Connect Sidecar binary is in the GitHub releases page for Connect.
...
3. **Point your chain binary at the Connect sidecar**
