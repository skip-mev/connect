...
func init() {
	file_connect_oracle_v2_tx_proto_init()
	md_MsgAddCurrencyPairs = File_connect_oracle_v2_tx_proto.Messages().ByName("MsgAddCurrencyPairs")
...
func (x *MsgAddCurrencyPairs) slowProtoReflect() protoreflect.Message {
	mi := &file_connect_oracle_v2_tx_proto_msgTypes[0]
...
func (x *fastReflection_MsgAddCurrencyPairs) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "connect.oracle.v2.MsgAddCurrencyPairs.authority":
		return x.Authority != ""
	case "connect.oracle.v2.MsgAddCurrencyPairs.currency_pairs":
		return len(x.CurrencyPairs) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: connect.oracle.v2.MsgAddCurrencyPairs"))
		}
		panic(fmt.Errorf("message connect.oracle.v2.MsgAddCurrencyPairs does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgAddCurrencyPairs) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message connect.oracle.v2.MsgAddCurrencyPairs does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgAddCurrencyPairs) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "connect.oracle.v2.MsgAddCurrencyPairs.authority":
		panic(fmt.Errorf("field authority of message connect.oracle.v2.MsgAddCurrencyPairs is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: connect.oracle.v2.MsgAddCurrencyPairs"))
		}
...
func (x *fastReflection_MsgAddCurrencyPairs) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in connect.oracle.v2.MsgAddCurrencyPairs", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_connect_oracle_v2_tx_proto_init()
	md_MsgAddCurrencyPairsResponse = File_connect_oracle_v2_tx_proto.Messages().ByName("MsgAddCurrencyPairsResponse")
}
...
func (x *MsgAddCurrencyPairsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_connect_oracle_v2_tx_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgAddCurrencyPairsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: connect.oracle.v2.MsgAddCurrencyPairsResponse"))
		}
		panic(fmt.Errorf("message connect.oracle.v2.MsgAddCurrencyPairsResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgAddCurrencyPairsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message connect.oracle.v2.MsgAddCurrencyPairsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgAddCurrencyPairsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in connect.oracle.v2.MsgAddCurrencyPairsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_connect_oracle_v2_tx_proto_init()
	md_MsgRemoveCurrencyPairs = File_connect_oracle_v2_tx_proto.Messages().ByName("MsgRemoveCurrencyPairs")
...
func (x *MsgRemoveCurrencyPairs) slowProtoReflect() protoreflect.Message {
	mi := &file_connect_oracle_v2_tx_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgRemoveCurrencyPairs) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "connect.oracle.v2.MsgRemoveCurrencyPairs.authority":
		return x.Authority != ""
	case "connect.oracle.v2.MsgRemoveCurrencyPairs.currency_pair_ids":
		return len(x.CurrencyPairIds) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: connect.oracle.v2.MsgRemoveCurrencyPairs"))
		}
		panic(fmt.Errorf("message connect.oracle.v2.MsgRemoveCurrencyPairs does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgRemoveCurrencyPairs) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message connect.oracle.v2.MsgRemoveCurrencyPairs does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgRemoveCurrencyPairs) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "connect.oracle.v2.MsgRemoveCurrencyPairs.currency_pair_ids":
		...
		return protoreflect.ValueOfList(value)
	case "connect.oracle.v2.MsgRemoveCurrencyPairs.authority":
		panic(fmt.Errorf("field authority of message connect.oracle.v2.MsgRemoveCurrencyPairs is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: connect.oracle.v2.MsgRemoveCurrencyPairs"))
		}
...
func (x *fastReflection_MsgRemoveCurrencyPairs) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in connect.oracle.v2.MsgRemoveCurrencyPairs", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_connect_oracle_v2_tx_proto_init()
	md_MsgRemoveCurrencyPairsResponse = File_connect_oracle_v2_tx_proto.Messages().ByName("MsgRemoveCurrencyPairsResponse")
}
...
func (x *MsgRemoveCurrencyPairsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_connect_oracle_v2_tx_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_MsgRemoveCurrencyPairsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: connect.oracle.v2.MsgRemoveCurrencyPairsResponse"))
		}
		panic(fmt.Errorf("message connect.oracle.v2.MsgRemoveCurrencyPairsResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_MsgRemoveCurrencyPairsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message connect.oracle.v2.MsgRemoveCurrencyPairsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_MsgRemoveCurrencyPairsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in connect.oracle.v2.MsgRemoveCurrencyPairsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
type MsgAddCurrencyPairs struct {
	...
	// set)
	CurrencyPairs []*v2.CurrencyPair `protobuf:"bytes,2,rep,name=currency_pairs,json=currencyPairs,proto3" json:"currency_pairs,omitempty"`
}
...
func (*MsgAddCurrencyPairs) Descriptor() ([]byte, []int) {
	return file_connect_oracle_v2_tx_proto_rawDescGZIP(), []int{0}
}
...
func (x *MsgAddCurrencyPairs) GetCurrencyPairs() []*v2.CurrencyPair {
	if x != nil {
...
func (*MsgAddCurrencyPairsResponse) Descriptor() ([]byte, []int) {
	return file_connect_oracle_v2_tx_proto_rawDescGZIP(), []int{1}
}
...
func (*MsgRemoveCurrencyPairs) Descriptor() ([]byte, []int) {
	return file_connect_oracle_v2_tx_proto_rawDescGZIP(), []int{2}
}
...
func (*MsgRemoveCurrencyPairsResponse) Descriptor() ([]byte, []int) {
	return file_connect_oracle_v2_tx_proto_rawDescGZIP(), []int{3}
}

var File_connect_oracle_v2_tx_proto protoreflect.FileDescriptor

var file_connect_oracle_v2_tx_proto_rawDesc = []byte{
	0x0a, 0x1a, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x2f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65,
	0x2f, 0x76, 0x32, 0x2f, 0x74, 0x78, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x63, 0x6f,
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x2e, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x2e, 0x76, 0x32, 0x1a,
	0x1f, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x2f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x2f,
	...
	0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x24, 0x63,
	0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2f, 0x76, 0x32, 0x2f,
	0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x5f, 0x70, 0x61, 0x69, 0x72, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x22, 0xd7, 0x01, 0x0a, 0x13, 0x4d, 0x73, 0x67, 0x41, 0x64, 0x64, 0x43, 0x75,
	0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x50, 0x61, 0x69, 0x72, 0x73, 0x12, 0x36, 0x0a, 0x09, 0x61,
	...
	0x69, 0x74, 0x79, 0x12, 0x4b, 0x0a, 0x0e, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x5f,
	0x70, 0x61, 0x69, 0x72, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x63, 0x6f,
	0x6e, 0x6e, 0x65, 0x63, 0x74, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x76, 0x32, 0x2e, 0x43,
	...
	0x3a, 0x3b, 0xe8, 0xa0, 0x1f, 0x00, 0x82, 0xe7, 0xb0, 0x2a, 0x09, 0x61, 0x75, 0x74, 0x68, 0x6f,
	0x72, 0x69, 0x74, 0x79, 0x8a, 0xe7, 0xb0, 0x2a, 0x24, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74,
	0x2f, 0x78, 0x2f, 0x6f, 0x72, 0x61, 0x63, 0x6c, 0x65, 0x2f, 0x4d, 0x73, 0x67, 0x41, 0x64, 0x64,
	0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x50, 0x61, 0x69, 0x72, 0x73, 0x22, 0x1d, 0x0a,
	0x1b, 0x4d, 0x73, 0x67, 0x41, 0x64, 0x64, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x50,
	0x61, 0x69, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xb9, 0x01, 0x0a,
	0x16, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e,
	...
	,
	...
	0x65, 0x2e, 0x76, 0x32, 0x2e, 0x4d, 0x73, 0x67, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x43, 0x75,
	0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x50, 0x61, 0x69, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x1a, 0x05, 0x80, 0xe7, 0xb0, 0x2a, 0x01, 0x42, 0xb3, 0x01, 0x0a, 0x15, 0x63,
	0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x2e, 0x6f, 0x72, 0x61, 0x63, 0x6c,
	0x65, 0x2e, 0x76, 0x32, 0x42, 0x07, 0x54, 0x78, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
...
var (
	file_connect_oracle_v2_tx_proto_rawDescOnce sync.Once
	file_connect_oracle_v2_tx_proto_rawDescData = file_connect_oracle_v2_tx_proto_rawDesc
)

func file_connect_oracle_v2_tx_proto_rawDescGZIP() []byte {
	file_connect_oracle_v2_tx_proto_rawDescOnce.Do(func() {
		file_connect_oracle_v2_tx_proto_rawDescData = protoimpl.X.CompressGZIP(file_connect_oracle_v2_tx_proto_rawDescData)
	})
	return file_connect_oracle_v2_tx_proto_rawDescData
}

var file_connect_oracle_v2_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_connect_oracle_v2_tx_proto_goTypes = []interface{}{
	(*MsgAddCurrencyPairs)(nil),            // 0: connect.oracle.v2.MsgAddCurrencyPairs
	(*MsgAddCurrencyPairsResponse)(nil),    // 1: connect.oracle.v2.MsgAddCurrencyPairsResponse
	(*MsgRemoveCurrencyPairs)(nil),         // 2: connect.oracle.v2.MsgRemoveCurrencyPairs
	(*MsgRemoveCurrencyPairsResponse)(nil), // 3: connect.oracle.v2.MsgRemoveCurrencyPairsResponse
	(*v2.CurrencyPair)(nil),                // 4: connect.types.v2.CurrencyPair
}
var file_connect_oracle_v2_tx_proto_depIdxs = []int32{
	4, // 0: connect.oracle.v2.MsgAddCurrencyPairs.currency_pairs:type_name -> connect.types.v2.CurrencyPair
	0, // 1: connect.oracle.v2.Msg.AddCurrencyPairs:input_type -> connect.oracle.v2.MsgAddCurrencyPairs
	2, // 2: connect.oracle.v2.Msg.RemoveCurrencyPairs:input_type -> connect.oracle.v2.MsgRemoveCurrencyPairs
	1, // 3: connect.oracle.v2.Msg.AddCurrencyPairs:output_type -> connect.oracle.v2.MsgAddCurrencyPairsResponse
	3, // 4: connect.oracle.v2.Msg.RemoveCurrencyPairs:output_type -> connect.oracle.v2.MsgRemoveCurrencyPairsResponse
...
func init() { file_connect_oracle_v2_tx_proto_init() }
func file_connect_oracle_v2_tx_proto_init() {
	if File_connect_oracle_v2_tx_proto != nil {
		return
	}
	file_connect_oracle_v2_genesis_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_connect_oracle_v2_tx_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_connect_oracle_v2_tx_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_connect_oracle_v2_tx_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_connect_oracle_v2_tx_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_connect_oracle_v2_tx_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_connect_oracle_v2_tx_proto_goTypes,
		DependencyIndexes: file_connect_oracle_v2_tx_proto_depIdxs,
		MessageInfos:      file_connect_oracle_v2_tx_proto_msgTypes,
	}.Build()
	File_connect_oracle_v2_tx_proto = out.File
	file_connect_oracle_v2_tx_proto_rawDesc = nil
	file_connect_oracle_v2_tx_proto_goTypes = nil
	file_connect_oracle_v2_tx_proto_depIdxs = nil
}
