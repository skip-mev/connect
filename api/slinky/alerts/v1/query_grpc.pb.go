...
const (
	Query_Alerts_FullMethodName = "/slinky.alerts.v1.Query/Alerts"
	Query_Params_FullMethodName = "/slinky.alerts.v1.Query/Params"
)
...
func (c *queryClient) Alerts(ctx context.Context, in *AlertsRequest, opts ...grpc.CallOption) (*AlertsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Alerts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) Alerts(context.Context, *AlertsRequest) (*AlertsResponse, error) {
